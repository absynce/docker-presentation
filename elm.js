...
var _user$project$Main$consistencyInDevelopment = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Consistency in development',
		_1: {
			ctor: '::',
			_0: '* No manual install/config',
			_1: {
				ctor: '::',
				_0: '* Declare requirements\n\n```dockerfile\nFROM node:7.2.0\n\nRUN npm install -g elm@0.18.0\nRUN npm install -g elm-test@0.18.0\n\nENTRYPOINT [\"elm\"]\n```\n[Source](https://github.com/maport/docker-elm/blob/master/elm/0.18/Dockerfile)',
				_1: {
					ctor: '::',
					_0: '[How to build an app container](https://docs.docker.com/get-started/part2/)',
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Main$whyDocker = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Why Docker',
		_1: {
			...
			_1: {
				ctor: '::',
				_0: '* Quick dev environment setup',
				_1: {
					ctor: '::',
					_0: '* Portability across platforms',
					_1: {
						ctor: '::',
						_0: '* Scaling apps',
						_1: {ctor: '[]'}
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Intro to Docker'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
		...
		_xarvh$elm_slides$Slides$slidesDefaultOptions,
		{
			style: A2(
				...
				A4(
					...
					A3(_rtfeldman$elm_css$Css$rgb, 230, 230, 230),
					_rtfeldman$elm_css$Css$px(30),
					_rtfeldman$elm_css$Css$hex('3a6ea5')),
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css_Elements$img(
						{
			...
			slidePixelSize: {height: 700, width: 1024}
		}),
	{
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _user$project$Main$whyDocker,
			_1: {
				ctor: '::',
